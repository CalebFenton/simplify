...
class APutOpTest {
    ...
    fun canInsertLocalClassAndClassIntoSameArray() {
        ...
        val classLoader: ClassLoader = Tester.spawnVM().classLoader
        ...
        Tester.test(CLASS_NAME, "putObjects()V", initial, expected)
    }
    ...
    fun canArrayIntoObjectArray() {
        ...
        Tester.test(CLASS_NAME, "putObject()V", initial, expected)
    }
    ...
    fun canPutBoolean() {
        ...
        Tester.test(CLASS_NAME, "putBoolean()V", initial, expected)
    }
    ...
    fun canPutByte() {
        ...
        Tester.test(CLASS_NAME, "putByte()V", initial, expected)
    }
    ...
    fun canPutChar() {
        ...
        Tester.test(CLASS_NAME, "putChar()V", initial, expected)
    }
    ...
    fun canPutIntegerWithShortIndex() {
        ...
        Tester.test(CLASS_NAME, "put()V", initial, expected)
    }
    ...
    fun canPutShort() {
        ...
        Tester.test(CLASS_NAME, "putShort()V", initial, expected)
    }
    ...
    fun canPutWideWithDouble() {
        ...
        Tester.test(CLASS_NAME, "putWide()V", initial, expected)
    }
    ...
    fun nullArrayValueThrowsNullPointerExceptionAndHasNoChildrenAndAssignsNoRegisters() {
        ...
        Tester.testSimpleException(CLASS_NAME, "putWithCatch()V", NullPointerException::class.java, initial, 2)
    }
    ...
    fun outOfBoundsIndexThrowsArrayIndexOutOfBoundsExceptionHasNoChildrenAndAssignsNoRegisters() {
        ...
        Tester.testSimpleException(CLASS_NAME, "putWithCatch()V", ArrayIndexOutOfBoundsException::class.java, initial, 2)
    }
    ...
    fun incompatibleValueTypeThrowsArrayStoreExceptionHasNoChildrenAndAssignsNoRegisters() {
        ...
        Tester.testSimpleException(CLASS_NAME, "putWithCatch()V", ArrayStoreException::class.java, initial, 2)
    }
    ...
    fun unknownValueItemMakesArrayUnknownAndThrowsExceptions() {
        ...
        val graph = Tester.execute(CLASS_NAME, "putWithCatch()V", initial)
