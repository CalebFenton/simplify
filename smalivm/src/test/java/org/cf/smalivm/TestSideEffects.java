...
public class TestSideEffects {
    ...
    public void TestConstOpsHaveNoSideEffects() {
        ...
        assertEquals(SideEffect.Level.NONE, graph.getHighestMethodSideEffectLevel());
    }
    ...
    public void TestInvokeMethodThatInvokesUnknownMethodHasStrongSideEffects() {
        ...
        assertEquals(SideEffect.Level.STRONG, graph.getHighestMethodSideEffectLevel());
    }
    ...
    public void TestModifyInstanceMemberHasStrongSideEffects() {
        ...
        assertEquals(SideEffect.Level.WEAK, graph.getHighestMethodSideEffectLevel());
    }
