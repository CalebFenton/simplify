...
public class MethodReflector {
    ...
    static {
        ...
        SafeClasses.add("Ljava/simplify.util/Map;");
        SafeClasses.add("Ljava/simplify.util/HashMap;");
        SafeClasses.add("Ljava/simplify.util/Hashtable;");

        SafeClasses.add("Ljava/simplify.util/List;");
        SafeClasses.add("Ljava/simplify.util/ArrayList;");

        SafeClasses.add("Ljava/simplify.util/Set;");
        SafeClasses.add("Ljava/simplify.util/HashSet;");
